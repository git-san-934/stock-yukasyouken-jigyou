...
州下記分野における完成品、組立品、基板実装品、部品単体・キット、金型・成形品等車載関連機器（カーマルチメディア、メーター、フロントパネル、各種スイッチ、
